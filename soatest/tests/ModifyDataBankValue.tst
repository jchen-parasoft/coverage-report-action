...
<SOAtestProject xmlVersion="5" productVersion="9.10.9">
 <TestSuite className="webtool.test.TestSuite" version="46.15.2">
  ...
  <EnvironmentConfiguration className="webtool.environment.EnvironmentConfiguration" version="1">
   ...
   <Environment className="webtool.environment.Environment" version="1">
    ...
    <EnvironmentVariable className="webtool.environment.EnvironmentVariable" version="3">
     <maskValue>AgAAACCmbxFRYyipZaXs3AkWKdFMtMij/qqF3uqRxAEsWdFcPg==</maskValue>
     <value>AgAAAFD60N1PaS9QscRfLIKLS8npxN1F6RrY90ucPn17+d3o3j3XwgwSxzQSEH0irpswnTMstaPEp7tPiCM9KIIeGlN/pZE0oKFG+3pm6MWhf8K19g==</value>
     <name>WSDL</name>
    </EnvironmentVariable>
    <EnvironmentVariable className="webtool.environment.EnvironmentVariable" version="3">
     <maskValue>AgAAACBtYNuMszZT05Kr7/O4v2CqUrbHJc2g3cpCLREBDP+0gQ==</maskValue>
     <value>AgAAAFA9wcTKpWOrZ1fhgS7j5/v/auGFGrj8lCSszqGuA1Xuvaf8YxFJik0Sw55gVtuohCSaehr8VV1a7tuccqpw97wkhTpoUQf4iXNsa4BK4z7J4g==</value>
     <name>ENDPOINT</name>
    </EnvironmentVariable>
   </Environment>
   <Environment className="webtool.environment.Environment" version="1">
    ...
    <variablesSize>2</variablesSize>
    <EnvironmentVariable className="webtool.environment.EnvironmentVariable" version="3">
     <maskValue>AgAAACDJV0AdqQC4cTYKkeyXgo28fpT4tGh1QAUxq/9MxiXm4Q==</maskValue>
     <value>AgAAAFCd6KhU8uJdV5Kd4GBjn6NDJYs8WLoQ/I7X0wlcRZ3IGoYxEfatiaf8haSonNvhXrbkLLDLM/Whvjh0ZB2gH2hF/9nXeq9N+RDOjrEUnN6ydA==</value>
     <name>WSDL</name>
    </EnvironmentVariable>
    <EnvironmentVariable className="webtool.environment.EnvironmentVariable" version="3">
     <maskValue>AgAAACDPSl7wL6FwSUFYLa2IAy7W3sekVR0+RMx/vZH/tP4WPA==</maskValue>
     <value>AgAAAFCP4UFvTNm492DK+TASG1YO3rcn0urDBBogb90qK8CjZJktCVAFVdQ974G4GW/TgGfTiiWAEjW5m+FusY8o7uxuKeAmI3wDIZHGSQs2ynfpBw==</value>
     <name>ENDPOINT</name>
    </EnvironmentVariable>
   </Environment>
  ...
  <name>Modify Data Bank Value</name>
  ...
  <SOAPRPCToolTest className="webtool.soap.SOAPRPCToolTest" version="3.4.15.2">
   ...
   <SOAPRPCTool className="webtool.soap.SOAPRPCTool" version="v.2.46.14">
    ...
    <name>SOAP Client - Populate Data Bank</name>
    ...
    <SOAPOutputProviderImpl className="webtool.soap.SOAPOutputProviderImpl" version="1.1.1">
     ...
     <XMLtoDataSource className="webtool.xml.XMLtoDataSource" version="v.2.8.14.14">
      ...
      <selectedXPathsSize>3</selectedXPathsSize>
      ...
      <SelectedXPath className="webtool.xml.SelectedXPath" version="1.3">
       <elementOption>1</elementOption>
       <contentOption>1</contentOption>
       <XMLDataBank_ExtractXPath>/*:Envelope/*:Body[1]/*:addItemToCartResponse[1]/itemAdded[1]/item[1]/quantity[1]/text()</XMLDataBank_ExtractXPath>
       <mode>1</mode>
      </SelectedXPath>
      <SelectedXPath className="webtool.xml.SelectedXPath" version="1.3">
       <elementOption>1</elementOption>
       <contentOption>1</contentOption>
       <XMLDataBank_ExtractXPath>/*:Envelope/*:Body[1]/*:addItemToCartResponse[1]/itemAdded[1]/item[1]/book[1]/id[1]/text()</XMLDataBank_ExtractXPath>
       <mode>1</mode>
      </SelectedXPath>
      <saveExpectedXML>true</saveExpectedXML>
      <xmlMessage>true</xmlMessage>
      <Message className="webtool.traffic.Message" version="1.5">
       <content></content>
      ...
      <VirtualDataSourceCreatorImpl className="webtool.data.VirtualDataSourceCreatorImpl" version="1.1">
       <writableColumnsSize>3</writableColumnsSize>
       <WritableColumn className="webtool.data.WritableColumn" version="1.5">
        <customName>Test 1: cartId</customName>
       </WritableColumn>
       <WritableColumn className="webtool.data.WritableColumn" version="1.5">
        <customName>Test 1: quantity</customName>
       </WritableColumn>
       <WritableColumn className="webtool.data.WritableColumn" version="1.5">
        <customName>Test 1: itemId</customName>
       </WritableColumn>
    ...
    <CallContainer className="webtool.soap.CallContainer" version="22">
     ...
     <SoapCall className="webtool.soap.SoapCall" version="11">
      ...
      <SoapMethod className="webtool.soap.SoapMethod" version="20">
       <beautify spDataVersion="9.10.4">false</beautify>
       ...
       <SOAPServiceAddress className="com.parasoft.ws.wsdl.SOAPServiceAddress" version="1.5">
        <portName>SecureCartServicePort</portName>
...
&lt;/SOAP-ENV:Envelope&gt;</SOAPClient_LiteralMessage>
       ...
       <XMLElementNode className="webtool.xml.builder.XMLElementNode" version="1.3.5">
        ...
        <XMLElementNode className="webtool.xml.builder.XMLElementNode" version="1.3.5">
         ...
         <XMLElementNode className="webtool.xml.builder.XMLElementNode" version="1.3.5">
          ...
          <name>add</name>
          <namespace>true</namespace>
          <uri>http://www.parasoft.com/wsdl/calculator/</uri>
  ...
  <ToolTest className="webtool.test.ToolTest" version="4.15.2">
   ...
   <MethodTool className="webtool.scripting.MethodTool" version="v.2.5.2.14">
    ...
    <name>Method - Modify Value and Store</name>
    <OutputProviderImpl className="com.parasoft.tool.OutputProviderImpl" version="1.1">
     ...
     <XMLtoDataSource className="webtool.xml.XMLtoDataSource" version="v.2.8.14.14">
      ...
      <SelectedXPath className="webtool.xml.SelectedXPath" version="1.3">
       <elementOption>1</elementOption>
       <contentOption>1</contentOption>
       <XMLDataBank_ExtractXPath>/root/z0[1]/text()</XMLDataBank_ExtractXPath>
       <mode>1</mode>
      </SelectedXPath>
      <saveExpectedXML>true</saveExpectedXML>
      <xmlMessage>true</xmlMessage>
      <Message className="webtool.traffic.Message" version="1.5">
       <content>PHJvb3Q+CiAgPHowPjY8L3owPgo8L3Jvb3Q+</content>
       <editable>true</editable>
       <headersAvailable>false</headersAvailable>
       <mimeType>true</mimeType>
       <MIMEType className="webtool.mime.MIMEType" version="5">
      ...
      <VirtualDataSourceCreatorImpl className="webtool.data.VirtualDataSourceCreatorImpl" version="1.1">
       ...
       <WritableColumn className="webtool.data.WritableColumn" version="1.5">
        <customName>Test 2: z0</customName>
       </WritableColumn>
      </VirtualDataSourceCreatorImpl>
     </XMLtoDataSource>
    </OutputProviderImpl>
...
def modifyValue(x, context):
  result = int(context.getValue(&quot;Generated Data Source&quot;, &quot;Test 1: quantity&quot;))
  result = result * 2
  return SOAPUtil.getXMLFromString( [str(result)] )
</text>
       </ScriptingTextInput>
      </ScriptingInput>
     </JythonCode>
     <methodId>true</methodId>
     <JythonMethodIdentifier className="com.parasoft.scripting.jython.JythonMethodIdentifier" version="2.1.1">
      <methodName>modifyValue</methodName>
     </JythonMethodIdentifier>
    </UserMethod>
   </MethodTool>
  ...
  <SOAPRPCToolTest className="webtool.soap.SOAPRPCToolTest" version="3.4.15.2">
   ...
   <SOAPRPCTool className="webtool.soap.SOAPRPCTool" version="v.2.46.14">
    <iconName>SOAPClient</iconName>
    <name>SOAP Client - Use Modified Value</name>
    <hasServiceInfo>true</hasServiceInfo>
    <ServiceInfo className="webtool.tool.ServiceInfo" version="1.2">
     <StandardServiceDescriptor className="com.parasoft.service.catalog.impl.StandardServiceDescriptor" version="1.1">
      <location>http://localhost:8080/parabank/services/store-01?wsdl</location>
    ...
    <EndpointProperties className="webtool.soap.EndpointProperties" version="1.4">
     ...
     <UDDIEndpointType className="webtool.soap.UDDIEndpointType" version="1.1.1">
      <SimpleValue className="webtool.data.SimpleValue" version="2.3">
       <columnName>Test 1: Result</columnName>
      </SimpleValue>
     </UDDIEndpointType>
     <CustomEndpointType className="webtool.soap.CustomEndpointType" version="1.1.1">
      <SimpleValue className="webtool.data.SimpleValue" version="2.3">
    ...
    <CallContainer className="webtool.soap.CallContainer" version="22">
     ...
     <SoapCall className="webtool.soap.SoapCall" version="11">
      ...
      <SoapMethod className="webtool.soap.SoapMethod" version="20">
       ...
       <portTypeName>ICalculator</portTypeName>
       <treeState>true</treeState>
       <TreeState className="com.parasoft.swing.TreeState" version="1">
       ...
       <SoapParameter className="webtool.soap.SoapParameter" version="10">
        <ElementValue className="webtool.soap.ElementValue" version="1.11.12">
         ...
         <qnameAsString>http://bookstore.parasoft.com/:addItemToCartResponse</qnameAsString>
         <size>1</size>
         <ComplexValue className="webtool.soap.ComplexValue" version="1.10.12">
          <compositorValue>true</compositorValue>
          <CompositorValue className="webtool.soap.CompositorValue" version="1.3.12">
       ...
       <SoapParameter className="webtool.soap.SoapParameter" version="10">
        <ElementValue className="webtool.soap.ElementValue" version="1.11.12">
         <writeType>true</writeType>
         <hasReference>true</hasReference>
         <qnameAsString>http://bookstore.parasoft.com/:addItemToCart</qnameAsString>
         <size>1</size>
         <ComplexValue className="webtool.soap.ComplexValue" version="1.10.12">
          <compositorValue>true</compositorValue>
          <CompositorValue className="webtool.soap.CompositorValue" version="1.3.12">
            ...
            <CompositorValueSet className="webtool.soap.CompositorValueSet" version="1.1">
             ...
             <ElementValue className="webtool.soap.ElementValue" version="1.11.12">
              ...
              <IntegerValue className="webtool.soap.IntegerValue" version="1.3.1.12">
               ...
               <mode>3</mode>
               <columnName>Test 1: cartId</columnName>
               <value>3</value>
              </IntegerValue>
             </ElementValue>
             <ElementValue className="webtool.soap.ElementValue" version="1.11.12">
              ...
              <IntegerValue className="webtool.soap.IntegerValue" version="1.3.1.12">
               <mode>3</mode>
               <columnName>Test 1: itemId</columnName>
               <value>1</value>
              </IntegerValue>
             </ElementValue>
             <ElementValue className="webtool.soap.ElementValue" version="1.11.12">
              ...
              <IntegerValue className="webtool.soap.IntegerValue" version="1.3.1.12">
               <mode>3</mode>
               <columnName>Test 2: z0</columnName>
               <value>6</value>
              </IntegerValue>
             </ElementValue>
            </CompositorValueSet>
...
&lt;/SOAP-ENV:Envelope&gt;</SOAPClient_LiteralMessage>
      ...
      <XMLBuilder className="webtool.xml.builder.XMLBuilder" version="6.6">
       ...
       <XMLElementNode className="webtool.xml.builder.XMLElementNode" version="1.3.5">
        ...
        <showNamespaces>true</showNamespaces>
        <childNodesSize>4</childNodesSize>
        <XMLNamespaceNode className="webtool.xml.builder.XMLNamespaceNode" version="1.1.5">
         <prefix>SOAP-ENV</prefix>
         <uri>http://schemas.xmlsoap.org/soap/envelope/</uri>
        ...
        <XMLElementNode className="webtool.xml.builder.XMLElementNode" version="1.3.5">
         ...
         <XMLElementNode className="webtool.xml.builder.XMLElementNode" version="1.3.5">
          ...
          <XMLElementNode className="webtool.xml.builder.XMLElementNode" version="1.3.5">
           ...
           <valueColumnName>Test 2: z0</valueColumnName>
           <value>0.0</value>
           <name>x</name>
           <namespace>true</namespace>
           <uri>http://www.parasoft.com/wsdl/calculator/</uri>
